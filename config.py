...
# 1. Carrega as chaves e define como variáveis de ambiente
...
# 2. Reconstrói o dicionário de credenciais do Google Sheets
...
# ESTADO REMOVIDO DAQUI. AGORA SERÁ GERENCIADO NO GRAFO E NO STREAMLIT.
